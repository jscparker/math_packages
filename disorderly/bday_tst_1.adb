...
-- Set up at present to test the compiler's Numerics.Discrete_Random.
--
...
-- and then counts how many of these random numbers occurred more than
-- once in the set of N.
--
...
procedure bday_tst_1 is
  ...
  Use_Compilers_Stnd_Generator : constant Boolean := True;
  --  IF False then use    Disorderly.Random
