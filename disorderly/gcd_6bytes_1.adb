...
procedure gcd_6bytes_1 is
  ...
  subtype GCD_Iterations_Test_Range is Unsigned_64 range 3..53;
  ...
  (
   2.35051159591539E-11, 2.23335776980042E-10, 1.57449658669479E-09,
  ...
  begin
    ...
    for i in Unsigned_64 range 1 .. Sample_Size loop
      ...
      Get_Pair: loop
         ...
         --u := Unsigned_64 (rnd.Basic_Rand (g));
         --v := Unsigned_64 (rnd.Basic_Rand (g));
...
begin
  ...
  test: declare
    ...
    -- need 2**38 pairs (bare min) to get 6 counts on average in 1st bin.
    -- The 1st bin is *very* rare event...combine it with 2nd bin to speed up x10.
    -- 2**38 Sample_Size takes a day using Basic_Rand;
    -- 2**39 Sample_Size is OK, chi squared wise.
    -- 2**40 Sample_Size is gd stnd tst. Tks days!
